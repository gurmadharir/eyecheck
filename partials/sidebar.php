<div class="sidebar">
  ...
  <ul class="nav-links">
    ...
    <?php if ($role === 'admin'): ?>
      ...
      <li><a href="/eyecheck/admin/manage-user-alerts.php" class="<?= ($page === 'user-alerts') ? 'active' : '' ?>">User Alerts</a></li>
      <li><a href="/eyecheck/admin/manage-logs.php" class="<?= ($page === 'logs') ? 'active' : '' ?>">User Logs</a></li>
